...
formulario.addEventListener('submit', function(e){
    ...
    //leer la marca seleccinada del select
    ...
    if(marcaSeleccionada === '' && resultados != null){
        //interfaz imprimendo un error 
        interfaz.mostrarMensaje('Faltan datos, revisar el formulario y prueba de nuevo', 'error');
        //Limpiar resultados anteriores en caso de haber
        resultados.remove();
    } else if(marcaSeleccionada === '' || anioSeleccionado === '' || tipo === ''){
        //interfaz imprimendo un error 
       interfaz.mostrarMensaje('Faltan datos, revisar el formulario y prueba de nuevo', 'error');
